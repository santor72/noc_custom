...
#        td = {"object": { "id": 220 }}
        ...
        try:
            with Span(in_label="start_of_path"):
                start, start_iface = self.get_object_and_interface(f)
        ...
        try:
            with Span(in_label="end_of_path"):
                end, end_iface = self.get_object_and_interface(t)
        ...
        pprint({"status": True, "paths": paths, "time": dt})
